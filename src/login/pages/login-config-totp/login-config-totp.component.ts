...
@Component({
  ...
  imports: [NgTemplateOutlet, KcSanitizePipe, MatButtonModule, MatCheckboxModule, MatInputModule],
  providers: [
    {
...
export class LoginConfigTotpComponent extends ComponentReference {
  ...
  displayInfo = false;
  displayMessage =
    this.kcContext.message?.type === 'error' || !this.kcContext.messagesPerField.existsError('totp', 'userLabel');
