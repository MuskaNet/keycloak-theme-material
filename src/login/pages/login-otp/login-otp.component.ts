...
@Component({
  imports: [NgTemplateOutlet, KcSanitizePipe, MatButtonModule, MatInputModule, MatRadioModule],
...
export class LoginOtpComponent extends ComponentReference {
  ...
  displayInfo = false;
  displayMessage = this.kcContext.message?.type === 'error' || this.kcContext.messagesPerField.existsError('totp');
