...
@Component({
  imports: [NgTemplateOutlet, KcSanitizePipe, MatButtonModule, MatIconModule, MatInputModule, MatProgressSpinnerModule],
...
export class LoginPasswordComponent extends ComponentReference {
  ...
  displayInfo = true;
  displayMessage = this.kcContext.message?.type === 'error' || this.kcContext.messagesPerField.existsError('password');
